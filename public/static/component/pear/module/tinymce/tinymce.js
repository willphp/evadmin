layui.define(['jquery'],function (exports) {
    ...
    function initOptions(option,callback) {
        ...
        option.plugins = isset(option.plugins) ? option.plugins : 'code kityformula-editor print preview searchreplace autolink fullscreen image link media codesample table charmap hr advlist lists wordcount imagetools indent2em';
        ...
        option.images_upload_handler = isset(option.images_upload_handler) ? option.images_upload_handler : function(blobInfo, success, failure) {
            ...
            xhr.open('POST', option.images_upload_url);
            xhr.onload = function () {
                let json;
                if (xhr.status !== 200) {
